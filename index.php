...
<body>
  ...
  <script src="js/documentation/jquery.doc.tabs.js" type="text/javascript"></script>
  <script src="js/documentation/highlight.pack.js" type="text/javascript"></script>
  <script src="js/documentation/docs.js" type="text/javascript"></script>
  <!-- PIN Javascript -->
  <script src="js/pandora/boot.js" type="text/javascript"></script>
    <script src="js/pandora/input-style.js" type="text/javascript"></script>
  <script src="js/pandora/init.js" type="text/javascript"></script>
